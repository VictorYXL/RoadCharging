...
def rl_test(data_path, network_path):
    ...
    data_folder = "/Data/liyan/ev_charging/HeurAgenix/src/problems/road_charging/marl/env/data/test_cases"
...
def main():
    ...
    # policy_name = "base_policy"
    if n_EVs == 5:
        # network_path = "/Data/liyan/ev_charging/HeurAgenix/src/problems/road_charging/marl/alg/discrete_action/param/net_param/actor_net1-5-5000-1739861249.pkl"
        # network_path = "/Data/liyan/ev_charging/HeurAgenix/src/problems/road_charging/marl/alg/discrete_action/param/net_param/actor_net1740025070.pkl"
        # network_path = "/Data/liyan/ev_charging/HeurAgenix/src/problems/road_charging/marl/alg/discrete_action/param/net_param/actor_net1-5-5000-sto1740029305.pkl"
        network_path = "/Data/liyan/ev_charging/HeurAgenix/src/problems/road_charging/marl/alg/discrete_action/param/net_param/actor_net1740035212.pkl"
        

        

    elif n_EVs == 8:
        network_path = "/Data/liyan/ev_charging/HeurAgenix/src/problems/road_charging/marl/alg/discrete_action/param/net_param/actor_net1-8-5000-1739960890.pkl"
    elif n_EVs == 10:
        network_path = "/Data/liyan/ev_charging/HeurAgenix/src/problems/road_charging/marl/alg/discrete_action/param/net_param/actor_net1-10-5000-1739863846.pkl"
