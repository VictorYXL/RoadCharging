...
if EV_NUM == 5:
    # data_file = "/Data/liyan/ev_charging/HeurAgenix/src/problems/road_charging/marl/env/data/config1_5EVs_1chargers.json"
    data_file = "/Data/liyan/ev_charging/HeurAgenix/src/problems/road_charging/marl/env/data/test_cases/all_days_negativePrices_highInitSoC_1for5/config1_5EVs_1chargers.json"
elif EV_NUM == 10:
    data_file = "/Data/liyan/ev_charging/HeurAgenix/src/problems/road_charging/marl/env/data/config1_10EVs_1chargers.json"
elif EV_NUM == 8:
    data_file = "/Data/liyan/ev_charging/HeurAgenix/src/problems/road_charging/marl/env/data/test_cases/all_days_negativePrices_highInitSoC_1for8/config1_8EVs_1chargers.json"
...
#         # 检查 k_probs 是否包含 inf、nan 或小于 0 的元素
#         if torch.any(torch.isnan(k_probs)) or torch.any(torch.isinf(k_probs)) or torch.any(k_probs < 0):
#             print("k_probs contains invalid values:")
#             print("k_logits:", k_logits)
#             print("k_probs:", k_probs)
#             raise ValueError("k_probs contains either `inf`, `nan` or element < 0")

        
#         # print("k_logits:", k_logits.t())
...
def test_network():
    agent = PPO()
    agent.load_param('/Data/liyan/ev_charging/HeurAgenix/src/problems/road_charging/marl/alg/discrete_action/param/net_param/actor_net1-10-5000-1739863846.pkl')  # 加载模型参数
    # 使用模型进行推理
